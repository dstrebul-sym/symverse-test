// Copyright (c) Symbotic, LLC. All rights reserved.
    ...
    return (function e(t, n, r) {
        ...
        7: [function(require, module, exports) {
            ...
            function createLayout(graph, physicsSettings) {
                ...
                var api = {
                    ...
                    moveNodeTo: function(nodeId, layout, graphics, x, y, loopAmount, timeInterval) {
                        userInteraction = true;
                        var node = graph.getNode(nodeId);

                        layout.pinNode(node);

                        var initPos = layout.getNodePosition(node.id);
                        var toMoveX = (x - initPos.x) / loopAmount;
                        var toMoveY = (y - initPos.y) / loopAmount;
        ...
        8: [function(require, module, exports) {
            ...
            function physicsSimulator(settings) {
                ...
                //TODO: Fix how to send in settings from dart class
        ...
        23: [function(require, module, exports) {
            ...
            function createGraph(options) {
                ...
                function addLink(fromId, toId, data) {
                    if(getLink(fromId,toId) != null) return;
                    enterModification();
                    ...
                    if (fromId !== toId) {
                        // makes sure we are not duplicating links for self-loops
        ...
        48: [function(require, module, exports) {
            ...
            function renderer(graph, settings) {
                ...
                return {
                     ...
                     *
                     * @param iterationsCount if specified
                      will run only given number of iterations
                ...
                function listenNodeEvents(node) {
                    ...
                    //This is commented out to disable the dragging functionality, may need to use click to trigger showing data later
